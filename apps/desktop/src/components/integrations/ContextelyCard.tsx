      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <span className="text-base font-semibold text-ink-text">Contextely</span>
          ...
          <div className="mt-4 border-t border-hairline pt-3">
            <div className="ldg-label mb-1.5">Company memory, in your questions</div>
            {!signedIn ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <Button size="sm" tone="secondary" onClick={disconnect} disabled={state.busy}>
              ...
              <div className="space-y-2">
                ...
                <Button size="sm" tone="ghost" onClick={() => void openExternal(CONTEXTELY_SIGNUP_URL)}>
          ...
          {/* ---- Ledgeur → Contextely ---- */}
          <div className="mt-4 border-t border-hairline pt-3">
            <div className="ldg-label mb-1.5 flex items-center gap-1.5">
            ...
            <div className="mt-2 flex items-center gap-2">
              <code className="min-w-0 flex-1 truncate rounded-lg border border-hairline bg-surface-sunken px-2.5 py-1.5 font-mono text-2xs text-ink-text">
                {endpoint}
              </code>
              <Button
                size="sm"
            ...
            <Button size="sm" tone="ghost" className="mt-1.5" onClick={() => void openExternal(CONTEXTELY_SOURCES_URL)}>
