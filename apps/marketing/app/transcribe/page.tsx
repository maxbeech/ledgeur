...
export const metadata: Metadata = {
  ...
  description:
    "Free, private meeting transcription for Zoom, Google Meet, Microsoft Teams, Webex and more. Ledgeur transcribes in your browser — no bot, no cloud upload.",
  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-14">
      ...
      <p className="mt-3 max-w-2xl text-stone-600">
        Whichever platform your meeting runs on, Ledgeur captures the audio in your browser and builds a
