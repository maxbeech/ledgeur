...
export const metadata: Metadata = {
  ...
  description:
    "Compare Ledgeur — the open-source, on-device AI meeting assistant — with Granola, Otter.ai, Fireflies, Fathom, tl;dv and more. Private, free for individuals.",
  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-14">
      ...
      <p className="mt-3 max-w-2xl text-stone-600">
        Most meeting-notes tools are closed-source and upload your audio to their cloud. Ledgeur runs in your
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2">
        {COMPETITORS.map((c) => (
          <Link key={c.slug} href={`/alternatives/${c.slug}`} className="rounded-xl border border-stone-200 bg-white p-5 hover:border-emerald-300">
            <div className="font-semibold text-stone-900">Ledgeur vs {c.name}</div>
